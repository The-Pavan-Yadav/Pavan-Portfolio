...
import { Mail, Github, Instagram, PhoneCall, Linkedin } from 'lucide-react';
...
const ContactCard: React.FC<{ social: any }> = ({ social }) => {
  ...
  return (
    <a
      ...
      className={`group relative flex flex-col items-center justify-center gap-1.5 sm:gap-3 md:gap-4 w-[70px] h-[70px] min-[380px]:w-[74px] min-[380px]:h-[74px] min-[440px]:w-[80px] min-[440px]:h-[80px] sm:w-28 sm:h-28 md:w-36 md:h-36 rounded-xl sm:rounded-2xl md:rounded-3xl border border-white/[0.04] bg-[#08080c]/50 backdrop-blur-2xl shadow-[0_8px_30px_rgba(0,0,0,0.5)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_20px_40px_rgba(255,255,255,0.05)] overflow-hidden ${social.glow}`}
    ...
    >
      ...
      <Icon className={`w-5 h-5 min-[380px]:w-6 min-[380px]:h-6 sm:w-8 sm:h-8 text-slate-500 transition-all duration-300 z-10 ${social.color} ${social.dropShadow} group-hover:scale-110`} />
      <span className={`text-slate-500 text-[8px] min-[380px]:text-[9px] sm:text-xs font-semibold tracking-wide transition-colors duration-500 z-10 ${social.color}`}>
        {social.label}
      </span>
    </a>
  );
...
export const Contact = () => {
  ...
  const socials = [
    ...
    { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/pavan-jala-a8614a322', color: 'group-hover:text-sky-400', glow: 'group-hover:shadow-[0_0_25px_rgba(56,189,248,0.15)] group-hover:border-sky-400/30', dropShadow: 'group-hover:drop-shadow-[0_0_12px_rgba(56,189,248,0.6)]', rgbGlow: 'rgba(56,189,248,0.1)' },
  ...
  return (
    <section id="contact" className="py-10 sm:py-16 md:py-32 px-4 md:px-6 relative z-10 w-full flex flex-col items-center justify-center overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-950/10 rounded-full blur-[180px] pointer-events-none mix-blend-screen" />
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10 flex flex-col items-center">
        ...
        <motion.div
           ...
           className="text-center mb-6 sm:mb-8 md:mb-12 flex flex-col items-center"
        >
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
            <div className="w-6 sm:w-8 md:w-12 h-[1px] bg-slate-700" />
            <span className="text-slate-400 text-[9px] sm:text-[10px] md:text-sm font-mono tracking-wider sm:tracking-widest md:tracking-[0.3em] uppercase font-bold">Contact</span>
            <div className="w-6 sm:w-8 md:w-12 h-[1px] bg-slate-700" />
          </div>

          <h2 className="text-[28px] min-[380px]:text-4xl sm:text-5xl md:text-7xl font-sans font-bold tracking-tight text-slate-100 mb-3 md:mb-6">
          ...
          <p className="text-slate-400/80 text-[11px] sm:text-sm md:text-base font-medium tracking-wide max-w-lg leading-relaxed px-4">
        ...
        <motion.div 
          ...
          viewport={{ once: true, margin: isMobile ? "-40px" : "-50px" }}
          transition={{ duration: isMobile ? 0.45 : 0.8, delay: isMobile ? 0.1 : 0.2, ease: "easeOut" }}
          className="flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-6 mb-10 md:mb-16 px-2 max-w-full"
        >
        ...
        <motion.div
           ...
           viewport={{ once: true }}
           transition={{ duration: isMobile ? 0.45 : 0.8, delay: isMobile ? 0.15 : 0.4 }}
           className="relative mb-12 sm:mb-16 md:mb-24 cursor-pointer inline-block"
        >
          ...
          <a 
            ...
            className="group relative inline-flex items-center gap-2 sm:gap-3 px-5 py-3 min-[380px]:px-6 min-[380px]:py-3.5 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-full bg-[#08080c]/50 backdrop-blur-2xl border border-white/[0.04] text-slate-200 font-bold text-[11px] min-[380px]:text-xs sm:text-sm md:text-base tracking-wide transition-all duration-500 hover:scale-[1.02] active:scale-95 hover:bg-[#08080c]/70 hover:border-white/[0.08] hover:text-white shadow-[0_8px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_40px_rgba(99,102,241,0.15),inset_0_0_20px_rgba(255,255,255,0.03)] overflow-hidden"
          >
        ...
        {/* Footer Area */}
        <div className="w-full pt-10 sm:pt-16 flex flex-col items-center relative">
          ...
          <div className="flex items-center gap-3 mb-4 sm:mb-6 mt-4">
            <div className="w-6 sm:w-8 h-[1px] bg-cyan-800/60" />
            <span className="font-display font-extrabold text-lg sm:text-xl md:text-2xl tracking-tighter text-white drop-shadow-[0_0_10px_rgba(34,211,238,0.4)]">
              P<span className="text-cyan-400">.</span>
            </span>
            <div className="w-6 sm:w-8 h-[1px] bg-cyan-800/60" />
          </div>

          <p className="text-slate-500 text-[9px] sm:text-[10px] md:text-xs font-mono uppercase tracking-widest font-semibold flex items-center gap-1.5 sm:gap-2">
